...
module "myec2" { #you can use any name here for the module
  source = "../ec2_Terraform-module" #pass this value to pick the existing terraform codes. its getting the logic from ec2-module
  #source = "git::https://hemanthvenugopal90@bitbucket.org/dptrealtime/ec2-terraform-module.git" - Can also use the module if it is in the Bitbucket/github remote repository.
